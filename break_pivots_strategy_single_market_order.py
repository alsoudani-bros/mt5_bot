    ...
    if not handlers.is_weekend_break():
        ...
        if not break_time:
            ...
            if not handlers.reached_max_loss(starting_balance, current_balance, 2):
                ...
                if last_candle_close > recent_pivot_high and last_candle_low <= recent_pivot_high and last_candle_close > last_candle_open and last_long_position_pivot_low != recent_pivot_low and last_long_position_pivot_high != recent_pivot_high:
                ...
                elif last_candle_close < recent_pivot_low and last_candle_high >= recent_pivot_low and  last_candle_close < last_candle_open and last_short_position_pivot_high != recent_pivot_high and last_short_position_pivot_low != recent_pivot_low:
