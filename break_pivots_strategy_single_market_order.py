...
def check_market(time_frame, risk_percent, risk_reward_ratio,max_gap_size,start_trading_hour, start_trading_minute, end_trading_hour, end_trading_minute):
    global symbol
    ...
    if not handlers.is_weekend_break():
        ...
        if trading_time:
            ...
            if not handlers.reached_max_loss(starting_balance, current_balance, 2):
                ...
                if last_candle_close > recent_pivot_high and last_candle_low <= recent_pivot_high and last_candle_close > last_candle_open and last_long_position_pivot_high != recent_pivot_high and gap_size < max_gap_size:
                ...
                elif last_candle_close < recent_pivot_low and last_candle_high >= recent_pivot_low and  last_candle_close < last_candle_open and last_short_position_pivot_low != recent_pivot_low and gap_size < max_gap_size:
