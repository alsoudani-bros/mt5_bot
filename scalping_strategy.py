...
def check_market(time_frame, risk_percent, risk_reward_ratio, starting_balance_for_the_week):
    ...
    if trading_time:
        ...
        if not handlers.reached_max_loss(starting_balance_for_the_week, current_balance, 4.5):
            ...
            if last_21_EMA > last_50_EMA and last_candle_low < last_21_EMA and last_candle_low > last_50_EMA and last_candle_close > last_21_EMA and not there_is_open_long_position and past_candles_close_above_21_EMA:
            ...
            elif last_21_EMA < last_50_EMA and last_candle_high > last_21_EMA and last_candle_high < last_50_EMA and last_candle_close < last_21_EMA and not there_is_open_short_position and past_candles_close_below_21_EMA:
